...
class PendingRequestVC: BaseVC,UITableViewDelegate, UITableViewDataSource {
    ...
    func fetchProductData() {
        FireStoreManager.shared.getAllRequestProductRecord(forUserId: UserDefaultsManager.shared.getDocumentId(), collectionStatus: "ProductRequestToManager") { [weak self] fetchedProducts, error in
              if let error = error {
